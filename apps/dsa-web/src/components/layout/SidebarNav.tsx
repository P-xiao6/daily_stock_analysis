...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, ListChecks, LogOut, MessageSquareQuote, Radar, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'watchlist', labelKey: 'layout.nav.watchlist', to: '/watchlist', icon: ListChecks },
  { key: 'realtime-watch', labelKey: 'layout.nav.realtimeWatch', to: '/realtime-watch', icon: Radar },
